...
```swift
.package(url: "https://github.com/1Sygnal/1sygnal-ios-sdk.git", from: "1.0.2")
```
...
```ruby
pod 'OneSygnalSDK', :podspec => 'https://raw.githubusercontent.com/1Sygnal/1sygnal-ios-sdk/1.0.2/OneSygnalSDK.podspec'
```
